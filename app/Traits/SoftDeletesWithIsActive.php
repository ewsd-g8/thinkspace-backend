...
trait SoftDeletesWithIsActive
{
     ...
     * @return void
     */
    public static function bootSoftDeletesWithIsActive()
    {
        static::addGlobalScope(new SoftDeletingWithIsActiveScope);
    }
    ...
    protected function runSoftDelete()
    {
        ...
        $columns = [$this->getIsActiveColumn() => 0];

        $this->{$this->getIsActiveColumn()} = 0;
    ...
    {
        return $this->{$this->getIsActiveColumn()} == 0;
    }
...
class SoftDeletingWithIsActiveScope implements Scope
{
    /**
     ...
     * @return string
     */
    protected function getIsActiveColumn(Builder $builder)
    {
    ...
    protected function addWithoutTrashed(Builder $builder)
    {
        $builder->macro('withoutTrashed', function (Builder $builder) {
            ...
            $builder->withoutGlobalScope($this)->where(
                $model->getQualifiedIsActiveColumn(), 1
            );
